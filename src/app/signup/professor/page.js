    ...
    return (
        ...
        <div className="flex items-center justify-center h-full">
            <div className="flex-col flex items-center justify-center">
                ...
                <div className="card w-full max-w-sm shrink-0 shadow">
                    ...
                    <form className="card-body">
                        <div className="form-control">
                            ...
                            <input type="nome" placeholder="" className="input input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input type="siape" placeholder="" className="input input-bordered" required />
                        </div>
                        ...
                        <label className="flex justify-center w-full p-3">
                            <a href="/login" className="label-text-alt link link-hover">Já possui conta ? Entre</a>
                        </label>
